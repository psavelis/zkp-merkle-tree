...
func AccountCommitment(accountID int, balance int, nonce int) (*big.Int, error) {
	...
	return poseidon2Permutation("leaf", []bn254fr.Element{
...
func NodeCommitment(left *big.Int, right *big.Int) (*big.Int, error) {
	...
	return poseidon2Permutation("node", []bn254fr.Element{*leftElement, *rightElement, bn254fr.NewElement(0)})
}

func poseidon2Permutation(seed string, elements []bn254fr.Element) (*big.Int, error) {
	hasher := poseidonbn254.NewHash(len(elements), 8, 56, seed)
