...
See [CONTRIBUTING.md](CONTRIBUTING.md) for validation steps, review expectations, and contribution scope.
...
The repository README is the current source of truth for package boundaries, security notes, and the study narrative.
